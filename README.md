...
AI Engineer with 2+ years of experience building NLP models, RAG pipelines, and LLM-based applications.

I focus on building end-to-end AI systems — from data pipelines and model training to API deployment and scalable services.
